...
<head>
  ...
  <style>
    ...
    .folder-container {
      margin-top: 20px;
      overflow: auto;
      /* Tambahkan overflow: auto untuk membuat tabel dapat di-scroll */
      max-height: 500px;
      /* Tambahkan max-height untuk mengatur tinggi maksimum tabel */
    }
    ...
    .folder-container img {
      ...
      object-fit: cover;
      cursor: pointer;
      /* Tambahkan untuk membuat gambar dapat diklik */
    }

    .folder-container img:hover {
      opacity: 0.8;
      /* Tambahkan untuk memberikan efek hover pada gambar */
    }
